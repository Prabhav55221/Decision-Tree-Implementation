...
# ##### 7. Using Graph_viz to build Decision Tree and save as PDF.
...
import pydotplus
dot_data = export_graphviz(clfsk, out_file=None, feature_names = df.feature_names, class_names = df.target_names ,filled=True, rounded=True)
